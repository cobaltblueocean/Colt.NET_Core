...
namespace Colt.Matrix
{
    ...
    public abstract class DoubleMatrix2D : AbstractMatrix2D
    {
        ...
        /// The rows of the cells that shall be visible in the new view. To indicate that <i>all</i> rows shall be visible, simply set this parameter to <tt>null</tt>.
        /// </param>
        /// <param name="columnIndexes">
        /// The columns of the cells that shall be visible in the new view. To indicate that <i>all</i> columns shall be visible, simply set this parameter to <tt>null</tt>.
        /// </param>
        /// <returns>
        /// The new view.
        /// </returns>
