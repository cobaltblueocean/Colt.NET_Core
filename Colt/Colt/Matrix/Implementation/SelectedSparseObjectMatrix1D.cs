...
*/
    public class SelectedSparseObjectMatrix1D : ObjectMatrix1D
    {
	  ...
	  */
         ...
         * @param offset   
         */
        protected SelectedSparseObjectMatrix1D(int size, IDictionary<int, Object> elements, int zero, int stride, int[] offsets, int offset)
        {
         ...
         */
        protected SelectedSparseObjectMatrix1D(IDictionary<int, Object> elements, int[] offsets):this(offsets.Length, elements, 0, 1, offsets, 0)
        {
