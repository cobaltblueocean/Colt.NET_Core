...
namespace Cern.Colt.List
{
    ...
    public class ByteArrayList : AbstractByteList
    {
        ...
        /// <summary>
        /// <param name="elements">the array to be backed by the the constructed list</param>
        public ByteArrayList(List<byte> elements)
        {
        ...
        public ByteArrayList(int initialCapacity) : this(new byte[initialCapacity])
        {
            SetSizeRaw(0);
        }
        /// <summary>
        ...
        public override void BeforeInsert(int index, byte element)
        {
        ...
        public override int BinarySearchFromTo(Byte key, int from, int to)
        {
        ...
        {
            // overridden for performance only.
            ByteArrayList clone = new ByteArrayList((Byte[])_elements.Clone());
        ...
        public override Byte[] GetElements()
        {
            return _elements;
        }
        /// <summary>
        ...
        public override AbstractByteList SetElements(Byte[] elements)
        {
        ...
        { //delta
          // overridden for performance only.
          //if (!(otherObj is ByteArrayList)) return base.Equals(otherObj);
            if (this == otherObj) return true;
            if (!(otherObj is ByteArrayList))
            {
                if (otherObj is IList<long>)
                {
                    var other = (IList<Byte>)otherObj;
            ...
            else
            {
                ...
                var other = (ByteArrayList)otherObj;
        ...
        public override Boolean ForEach(IntProcedureDelegate procedure)
        {
            // overridden for performance only.
        ...
        /// <summary>
        /// <param name="index">index of element to return.</param>
        protected override Byte GetQuick(int index)
        {
            return _elements[index];
        }
        /// <summary>
        ...
        public override int IndexOfFromTo(int element, int from, int to)
        {
            // overridden for performance only.
            if (Size == 0) return -1;
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=Size)</i>). </exception>
        public override AbstractByteList PartFromTo(int from, int to)
        {
            if (Size == 0) return new ByteArrayList(0);

            CheckRangeFromTo(from, to, Size);

            var part = new Byte[to - from + 1];
        ...
        public override Boolean RemoveAll(AbstractByteList other)
        {
            // overridden for performance only.
            if (!(other is ByteArrayList)) return base.RemoveAll(other);
        ...
        public override void ReplaceFromToWithFrom(int from, int to, AbstractByteList other, int otherFrom)
        {
            // overridden for performance only.
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((ByteArrayList)other).Elements, otherFrom, _elements, from, Length);
            }
        }
        /// <summary>
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public override Boolean RetainAll(AbstractByteList other)
        {
            // overridden for performance only.
            if (!(other is ByteArrayList)) return base.RetainAll(other);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (index </exception>
        /// 		  &lt; 0 || index &gt;= Size).
        public override void Set(int index, Byte element)
        {
            // overridden for performance only.
            if (index >= Size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + Size);
        ...
        /// <param name="index">index of element to replace.</param>
        /// <param name="element">element to be stored at the specified position.</param>
        protected override void SetQuick(int index, Byte element)
        {
            _elements[index] = element;
        }
        /// <summary>
