// <copyright file="AbstractDoubleList.cs" company="CERN">
...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractDoubleList : AbstractList<Double>
    {
        /// <summary>
        ...
        public virtual double[] Elements
        {
            get
            {
                double[] myElements = new double[_size];
            ...
            {
                Clear();
                AddAllOfFromTo(new DoubleArrayList(value), 0, value.Length - 1);
            }
        }
        ...
        public virtual void AddAllOf(DoubleArrayList other)
        {
        ...
        public virtual void AddAllOfFromTo(AbstractDoubleList other, int from, int to)
        {
        ...
        public virtual void BeforeInsert(int index, double element)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Count&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Count)</i>). </exception>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>index &lt; 0 || index &gt; _size()</i>). </exception>
        public virtual void BeforeInsertAllOfFromTo(int index, AbstractDoubleList other, int from, int to)
        {
        ...
        public virtual int BinarySearch(double key)
        {
        ...
        ///	and only if the key is found.
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(double key, int from, int to)
        {
            int low = from;
            int high = to;
            while (low <= high)
        ...
        public override Boolean Contains(double elem)
        {
        ...
        public virtual void Delete(double element)
        {
        ...
        public virtual double[] GetElements()
        {
            double[] myElements = new double[_size];
            for (int i = _size; --i >= 0;) myElements[i] = GetQuick(i);
            return myElements;
        ...
        public virtual AbstractDoubleList SetElements(double[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractDoubleList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, double val)
        {
        ...
        public virtual Boolean ForEach(DoubleProcedureDelegate procedure)
        {
        ...
        public override int IndexOf(double element)
        { //delta
        ...
        public virtual int IndexOfFromTo(double element, int from, int to)
        {
        ...
        public virtual int LastIndexOf(double element)
        {
        ...
        /// <returns> the index of the last occurrence of the element in the receiver; returns <code>-1</code> if the element is not found.</returns>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual int LastIndexOfFromTo(double element, int from, int to)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void MergeSortFromTo(int from, int to, DoubleComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual AbstractDoubleList PartFromTo(int from, int to)
        {
            CheckRangeFromTo(from, to, _size);

            int Length = to - from + 1;
            var part = new DoubleArrayList(Length);
        ...
        /// <see cref="Comparator"></see>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void QuickSortFromTo(int from, int to, DoubleComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        public virtual Boolean RemoveAll(AbstractDoubleList other)
        {
        ...
        /// </pre>
        public virtual void ReplaceFromToWithFromTo(int from, int to, AbstractDoubleList other, int otherFrom, int otherTo)
        {
        ...
        public override void ReplaceFromWith(int from, ICollection<Double> other)
        {
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public virtual Boolean RetainAll(AbstractDoubleList other)
        {
            if (other.Size == 0)
            {
        ...
        /// <exception cref="IndexOutOfRangeException">if <i>index &lt; 0 || index &gt;= _size()</i>. </exception>
        public virtual void Set(int index, double element)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + _size);
        ...
        public virtual AbstractDoubleList Times(int times)
        {
        ...
        {
            int mySize = Size;
            var list = new List<Double>(mySize);
