...
namespace Cern.Colt.List
{
    ...
    public class CharArrayList : AbstractCharList
    {
        ...
        /// <summary>
        /// <param name="elements">the array to be backed by the the constructed list</param>
        public CharArrayList(List<Char> elements)
        {
        ...
        public CharArrayList(int initialCapacity) : this(new Char[initialCapacity])
        {
            SetSizeRaw(0);
        }
        /// <summary>
        ...
        public override void BeforeInsert(int index, Char element)
        {
        ...
        public override int BinarySearchFromTo(Char key, int from, int to)
        {
        ...
        public override Char[] GetElements()
        {
            return _elements;
        }
        /// <summary>
        ...
        public override AbstractCharList SetElements(Char[] elements)
        {
        ...
        { //delta
          // overridden for performance only.
          //if (!(otherObj is CharArrayList)) return base.Equals(otherObj);
            if (this == otherObj) return true;
            if (!(otherObj is CharArrayList))
            {
                if (otherObj is IList<Char>)
                {
                    var other = (IList<Char>)otherObj;
            ...
            else
            {
                ...
                var other = (CharArrayList)otherObj;
        ...
        /// <summary>
        /// <param name="index">index of element to return.</param>
        protected override Char GetQuick(int index)
        {
            return _elements[index];
        }
        /// <summary>
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=Size)</i>). </exception>
        public override AbstractCharList PartFromTo(int from, int to)
        {
            if (Size == 0) return new CharArrayList(0);

            CheckRangeFromTo(from, to, Size);

            var part = new Char[to - from + 1];
        ...
        public override Boolean RemoveAll(AbstractCharList other)
        {
            // overridden for performance only.
            if (!(other is CharArrayList)) return base.RemoveAll(other);
        ...
        public override void ReplaceFromToWithFrom(int from, int to, AbstractCharList other, int otherFrom)
        {
            // overridden for performance only.
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((CharArrayList)other).Elements, otherFrom, _elements, from, Length);
            }
        }
        /// <summary>
        ...
        {
            // overridden for performance only.
            if (!(other is CharArrayList)) return base.RetainAll(other);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (index </exception>
        /// 		  &lt; 0 || index &gt;= Size).
        public override void Set(int index, Char element)
        {
            // overridden for performance only.
            if (index >= Size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + Size);
        ...
        /// <param name="index">index of element to replace.</param>
        /// <param name="element">element to be stored at the specified position.</param>
        protected override void SetQuick(int index, Char element)
        {
            _elements[index] = element;
        }
        /// <summary>
