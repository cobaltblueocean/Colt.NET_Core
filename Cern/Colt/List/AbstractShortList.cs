// <copyright file="AbstractshortList.cs" company="CERN">
...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractShortList : AbstractList<short>
    {
        /// <summary>
        ...
        public virtual short[] Elements
        {
            get
            {
                var myElements = new short[_size];
            ...
            {
                Clear();
                AddAllOfFromTo(new ShortArrayList(value), 0, value.Length - 1);
            }
        }
        ...
        public override void Add(short element)
        {
        ...
        public virtual void AddAllOf(ShortArrayList other)
        {
        ...
        public virtual void AddAllOfFromTo(AbstractShortList other, int from, int to)
        {
        ...
        public virtual void BeforeInsert(int index, short element)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Count&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Count)</i>). </exception>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>index &lt; 0 || index &gt; _size()</i>). </exception>
        public virtual void BeforeInsertAllOfFromTo(int index, AbstractShortList other, int from, int to)
        {
        ...
        public virtual int BinarySearch(short key)
        {
        ...
        ///	and only if the key is found.
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(short key, int from, int to)
        {
            int low = from;
            int high = to;
            while (low <= high)
        ...
        public override Boolean Contains(short elem)
        {
        ...
        public virtual void Delete(short element)
        {
        ...
        public virtual short[] GetElements()
        {
            var myElements = new short[_size];
            for (int i = _size; --i >= 0;) myElements[i] = GetQuick(i);
            return myElements;
        ...
        public virtual AbstractShortList SetElements(short[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractShortList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, short val)
        {
        ...
        public virtual Boolean ForEach(ShortProcedureDelegate procedure)
        {
        ...
        public override int IndexOf(short element)
        { //delta
        ...
        public virtual int IndexOfFromTo(short element, int from, int to)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void MergeSortFromTo(int from, int to, ShortComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual AbstractShortList PartFromTo(int from, int to)
        {
            CheckRangeFromTo(from, to, _size);

            int Length = to - from + 1;
            var part = new ShortArrayList(Length);
        ...
        /// <see cref="Comparator"></see>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void QuickSortFromTo(int from, int to, ShortComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        public virtual Boolean RemoveAll(AbstractShortList other)
        {
        ...
        public virtual void ReplaceFromToWithFrom(int from, int to, AbstractShortList other, int otherFrom)
        {
            int Length = to - from + 1;
            if (Length > 0)
            {
        ...
        /// </pre>
        public virtual void ReplaceFromToWithFromTo(int from, int to, AbstractShortList other, int otherFrom, int otherTo)
        {
        ...
        public override void ReplaceFromWith(int from, ICollection<short> other)
        {
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public virtual Boolean RetainAll(AbstractShortList other)
        {
            if (other.Size == 0)
            {
        ...
        /// <exception cref="IndexOutOfRangeException">if <i>index &lt; 0 || index &gt;= _size()</i>. </exception>
        public virtual void Set(int index, short element)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + _size);
        ...
        public virtual AbstractShortList Times(int times)
        {
        ...
        /// Returns a <code>java.util.List</code> containing all the elements in the receiver.
        /// <summary>
        public override List<short> ToList()
        {
            int mySize = Size;
            var list = new List<short>(mySize);
