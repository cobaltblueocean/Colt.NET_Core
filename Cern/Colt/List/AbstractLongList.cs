...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractLongList : AbstractList<long>
    {
        /// <summary>
        ...
        public virtual long[] Elements
        {
            ...
            {
                Clear();
                AddAllOfFromTo(new LongArrayList(value), 0, value.Length - 1);
            }
        }
        ...
        public virtual void AddAllOf(LongArrayList other)
        {
        ...
        public virtual void BeforeInsert(int index, long element)
        {
        ...
        public virtual int BinarySearch(long key)
        {
        ...
        ///	and only if the key is found.
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(long key, int from, int to)
        {
            int low = from;
            int high = to;
            while (low <= high)
        ...
        public override Boolean Contains(long elem)
        {
        ...
        public virtual void Delete(long element)
        {
        ...
        public virtual long[] GetElements()
        {
            var myElements = new long[_size];
            for (int i = _size; --i >= 0;) myElements[i] = GetQuick(i);
            return myElements;
        ...
        public virtual AbstractLongList SetElements(long[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractLongList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, long val)
        {
        ...
        public virtual Boolean ForEach(LongProcedureDelegate procedure)
        {
        ...
        public override int IndexOf(long element)
        { //delta
        ...
        public virtual int IndexOfFromTo(long element, int from, int to)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void MergeSortFromTo(int from, int to, LongComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual AbstractLongList PartFromTo(int from, int to)
        {
            CheckRangeFromTo(from, to, _size);

            int Length = to - from + 1;
            var part = new LongArrayList(Length);
        ...
        /// <see cref="Comparator"></see>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void QuickSortFromTo(int from, int to, LongComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        public virtual Boolean RemoveAll(AbstractLongList other)
        {
        ...
        public override void ReplaceFromWith(int from, ICollection<long> other)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">if <i>index &lt; 0 || index &gt;= _size()</i>. </exception>
        public virtual void Set(int index, long element)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + _size);
        ...
        public virtual AbstractLongList Times(int times)
        {
        ...
        /// Returns a <code>java.util.List</code> containing all the elements in the receiver.
        /// <summary>
        public override List<long> ToList()
        {
            int mySize = Size;
            var list = new List<long>(mySize);
