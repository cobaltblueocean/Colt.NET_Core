...
namespace Cern.Colt.List
{
    ...
    public class DoubleArrayList : AbstractDoubleList
    {
        ...
        /// <summary>
        public DoubleArrayList() : this(10)
        {
        ...
        /// <summary>
        /// <param name="elements">the array to be backed by the the constructed list</param>
        public DoubleArrayList(List<double> elements)
        {
        ...
        public DoubleArrayList(int initialCapacity) : this(new double[initialCapacity])
        {
            SetSizeRaw(0);
        }
        /// <summary>
        ...
        {
            // overridden for performance only.
            DoubleArrayList clone = new DoubleArrayList((double[])_elements.Clone());
        ...
        public override double[] GetElements()
        {
            return _elements;
        }
        /// <summary>
        ...
        public override AbstractDoubleList SetElements(double[] elements)
        {
        ...
        { //delta
          // overridden for performance only.
            ...
            {
                if (otherObj is IList<Double>)
                {
                    var other = (IList<Double>)otherObj;
        ...
        public override Boolean ForEach(DoubleProcedureDelegate procedure)
        {
            // overridden for performance only.
        ...
        /// <summary>
        /// <param name="index">index of element to return.</param>
        protected override double GetQuick(int index)
        {
            return _elements[index];
        }
        /// <summary>
        ...
        public override Boolean RemoveAll(AbstractDoubleList other)
        {
            // overridden for performance only.
            if (!(other is DoubleArrayList)) return base.RemoveAll(other);
        ...
        public override void ReplaceFromToWithFrom(int from, int to, AbstractDoubleList other, int otherFrom)
        {
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((DoubleArrayList)other).Elements, otherFrom, _elements, from, Length);
            }
        }
        /// <summary>
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public override Boolean RetainAll(AbstractDoubleList other)
        {
            // overridden for performance only.
            if (!(other is DoubleArrayList)) return base.RetainAll(other);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (index </exception>
        /// 		  &lt; 0 || index &gt;= Size).
        public override void Set(int index, double element)
        {
            // overridden for performance only.
            if (index >= Size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + Size);
        ...
        /// <param name="index">index of element to replace.</param>
        /// <param name="element">element to be stored at the specified position.</param>
        protected override void SetQuick(int index, double element)
        {
            _elements[index] = element;
        }
        /// <summary>
