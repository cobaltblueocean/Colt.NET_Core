// <copyright file="AbstractfloatList.cs" company="CERN">
...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractFloatList : AbstractList<float>
    {
        /// <summary>
        ...
        public virtual float[] Elements
        {
            get
            {
                var myElements = new float[_size];
            ...
            {
                Clear();
                AddAllOfFromTo(new FloatArrayList(value), 0, value.Length - 1);
            }
        }
        ...
        public virtual void AddAllOf(FloatArrayList other)
        {
        ...
        public virtual void AddAllOfFromTo(AbstractFloatList other, int from, int to)
        {
        ...
        public virtual void BeforeInsert(int index, float element)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Count&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Count)</i>). </exception>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>index &lt; 0 || index &gt; _size()</i>). </exception>
        public virtual void BeforeInsertAllOfFromTo(int index, AbstractFloatList other, int from, int to)
        {
        ...
        public virtual int BinarySearch(float key)
        {
        ...
        ///	and only if the key is found.
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(float key, int from, int to)
        {
            int low = from;
            int high = to;
            while (low <= high)
        ...
        public override Boolean Contains(float elem)
        {
        ...
        public virtual void Delete(float element)
        {
        ...
        public virtual float[] GetElements()
        {
            var myElements = new float[_size];
            for (int i = _size; --i >= 0;) myElements[i] = GetQuick(i);
            return myElements;
        ...
        public virtual AbstractFloatList SetElements(float[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractFloatList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, float val)
        {
        ...
        public override int IndexOf(float element)
        { //delta
        ...
        public virtual int IndexOfFromTo(float element, int from, int to)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual AbstractFloatList PartFromTo(int from, int to)
        {
            CheckRangeFromTo(from, to, _size);

            int Length = to - from + 1;
            var part = new FloatArrayList(Length);
        ...
        public virtual Boolean RemoveAll(AbstractFloatList other)
        {
        ...
        public virtual void ReplaceFromToWithFrom(int from, int to, AbstractFloatList other, int otherFrom)
        {
            int Length = to - from + 1;
            if (Length > 0)
            {
        ...
        /// </pre>
        public virtual void ReplaceFromToWithFromTo(int from, int to, AbstractFloatList other, int otherFrom, int otherTo)
        {
        ...
        public override void ReplaceFromWith(int from, ICollection<float> other)
        {
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public virtual Boolean RetainAll(AbstractFloatList other)
        {
            if (other.Size == 0)
            {
        ...
        /// <exception cref="IndexOutOfRangeException">if <i>index &lt; 0 || index &gt;= _size()</i>. </exception>
        public virtual void Set(int index, float element)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + _size);
        ...
        public virtual AbstractFloatList Times(int times)
        {
        ...
        /// Returns a <code>java.util.List</code> containing all the elements in the receiver.
        /// <summary>
        public override List<float> ToList()
        {
            int mySize = Size;
            var list = new List<float>(mySize);
