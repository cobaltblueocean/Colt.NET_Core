// <copyright file="AbstractByteList.cs" company="CERN">
...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractByteList : AbstractList<Byte>
    {
        /// <summary>
        ...
        public virtual byte[] Elements
        {
            get
            {
                var myElements = new Byte[_size];
            ...
            {
                Clear();
                AddAllOfFromTo(new ByteArrayList(value), 0, value.Length - 1);
            }
        }
        ...
        public override void Add(Byte element)
        {
        ...
        public virtual void AddAllOf(ByteArrayList other)
        {
        ...
        public virtual void AddAllOfFromTo(AbstractByteList other, int from, int to)
        {
        ...
        public virtual void BeforeInsert(int index, Byte element)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Count&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Count)</i>). </exception>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>index &lt; 0 || index &gt; _size()</i>). </exception>
        public virtual void BeforeInsertAllOfFromTo(int index, AbstractByteList other, int from, int to)
        {
        ...
        public virtual int BinarySearch(Byte key)
        {
        ...
        ///	and only if the key is found.
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(Byte key, int from, int to)
        {
            int low = from;
            int high = to;
            while (low <= high)
        ...
        public override Boolean Contains(Byte elem)
        {
        ...
        public virtual void Delete(Byte element)
        {
        ...
        public virtual Byte[] GetElements()
        {
            var myElements = new Byte[_size];
            for (int i = _size; --i >= 0;) myElements[i] = GetQuick(i);
            return myElements;
        ...
        public virtual AbstractByteList SetElements(Byte[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractByteList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, Byte val)
        {
        ...
        public override int IndexOf(Byte element)
        { //delta
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void MergeSortFromTo(int from, int to, ByteComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual AbstractByteList PartFromTo(int from, int to)
        {
            CheckRangeFromTo(from, to, _size);

            int Length = to - from + 1;
            var part = new ByteArrayList(Length);
        ...
        /// <see cref="Comparator"></see>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size()&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size())</i>). </exception>
        public virtual void QuickSortFromTo(int from, int to, ByteComparatorDelegate c)
        {
            int mySize = Size;
            CheckRangeFromTo(from, to, mySize);
        ...
        public virtual Boolean RemoveAll(AbstractByteList other)
        {
        ...
        public virtual void ReplaceFromToWithFrom(int from, int to, AbstractByteList other, int otherFrom)
        {
            int Length = to - from + 1;
            if (Length > 0)
            {
        ...
        /// </pre>
        public virtual void ReplaceFromToWithFromTo(int from, int to, AbstractByteList other, int otherFrom, int otherTo)
        {
        ...
        public override void ReplaceFromWith(int from, ICollection<Byte> other)
        {
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public virtual Boolean RetainAll(AbstractByteList other)
        {
            if (other.Size == 0)
            {
        ...
        public virtual AbstractByteList Times(int times)
        {
        ...
        /// Returns a <code>java.util.List</code> containing all the elements in the receiver.
        /// <summary>
        public override List<Byte> ToList()
        {
            int mySize = Size;
            var list = new List<Byte>(mySize);
