...
namespace Cern.Colt.List
{
    ...
    /// </summary>
    public class IntArrayList : AbstractIntList
    {
        /// <summary>
        ...
        /// <summary>
        /// <param name="elements">the array to be backed by the the constructed list</param>
        public IntArrayList(List<int> elements)
        {
        ...
        public IntArrayList(int initialCapacity) : this(new int[initialCapacity])
        {
            SetSizeRaw(0);
        }
        /// <summary>
        ...
        public override void BeforeInsert(int index, int element)
        {
        ...
        public override int BinarySearchFromTo(int key, int from, int to)
        {
        ...
        {
            // overridden for performance only.
            IntArrayList clone = new IntArrayList((int[])_elements.Clone());
        ...
        public override AbstractIntList SetElements(int[] elements)
        {
        ...
        { //delta
          // overridden for performance only.
          //if (!(otherObj is IntArrayList)) return base.Equals(otherObj);
            if (this == otherObj) return true;
            if (!(otherObj is IntArrayList))
            {
                if (otherObj is IList<int>)
                {
                    var other = (IList<int>)otherObj;
        ...
        /// <summary>
        /// <param name="index">index of element to return.</param>
        protected override int GetQuick(int index)
        {
            return _elements[index];
        }
        /// <summary>
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=Size)</i>). </exception>
        public override AbstractIntList PartFromTo(int from, int to)
        {
        ...
        {
            // overridden for performance only.
            if (!(other is IntArrayList)) return base.RemoveAll(other);
        ...
        public override void ReplaceFromToWithFrom(int from, int to, AbstractIntList other, int otherFrom)
        {
            // overridden for performance only.
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((IntArrayList)other).Elements, otherFrom, _elements, from, Length);
            }
        }
        /// <summary>
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public override Boolean RetainAll(AbstractIntList other)
        {
            // overridden for performance only.
            if (!(other is IntArrayList)) return base.RetainAll(other);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (index </exception>
        /// 		  &lt; 0 || index &gt;= Size).
        public override void Set(int index, int element)
        {
            // overridden for performance only.
            if (index >= Size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + Size);
        ...
        /// <param name="index">index of element to replace.</param>
        /// <param name="element">element to be stored at the specified position.</param>
        protected override void SetQuick(int index, int element)
        {
            _elements[index] = element;
        }
        /// <summary>
