// <copyright file="AbstractBooleanList.cs" company="CERN">
...
namespace Cern.Colt.List
{
    ...
    /// <summary>
    public abstract class AbstractBooleanList : AbstractList<Boolean>
    {
        /// <summary>
        /// The _size of the list.
        /// This is a READ_ONLY variable for all methods but SetSizeRawRaw(int new_size) !!!
        ...
        public override Boolean this[int index]
        {
            get
            {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Size)</i>). </exception>
        public virtual void AddAllOfFromTo(AbstractBooleanList other, int from, int to)
        {
        ...
        public virtual void BeforeInsert(int index, Boolean element)
        {
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>other.Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=other.Size)</i>). </exception>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>index &lt; 0 || index &gt; _size</i>). </exception>
        public virtual void BeforeInsertAllOfFromTo(int index, AbstractBooleanList other, int from, int to)
        {
        ...
        ///	element greater than the key, or <i>receiver.Size</i>, if all
        ...
        public virtual int BinarySearch(Boolean key)
        {
        ...
        /// <returns>index of the search key, if it is contained in the receiver;</returns>
        /// <see cref="java.util.Arrays"></see>
        public virtual int BinarySearchFromTo(Boolean key, int from, int to)
        {
            int low = from;
            int high = to;
        ...
        public override Boolean Contains(Boolean elem)
        {
        ...
        public virtual void Delete(Boolean element)
        {
        ...
        public virtual Boolean[] GetElements()
        {
            Boolean[] myElements = new Boolean[_size];
        ...
        public virtual AbstractBooleanList SetElements(Boolean[] elements)
        {
            Clear();
        ...
        { //delta
            if (!(otherObj is AbstractBooleanList)) { return false; }
        ...
        public virtual void FillFromToWith(int from, int to, Boolean val)
        {
        ...
        public virtual Boolean Get(int index)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", _size: " + _size);
            return GetQuick(index);
        ...
        public override int IndexOf(Boolean element)
        { //delta
        ...
        public virtual int IndexOfFromTo(Boolean element, int from, int to)
        {
        ...
        public virtual int LastIndexOf(Boolean element)
        {
        ...
        /// <returns> the index of the last occurrence of the element in the receiver; returns <code>-1</code> if the element is not found.</returns>
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>_size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=_size)</i>). </exception>
        public virtual int LastIndexOfFromTo(Boolean element, int from, int to)
        {
            CheckRangeFromTo(from, to, _size);
        ...
        public virtual Boolean RemoveAll(AbstractBooleanList other)
        {
        ...
        /// This call Booleanens the list by <i>(to - from + 1)</i> elements.
        /// 
        /// <summary>
        ...
        public virtual void ReplaceFromToWithFrom(int from, int to, AbstractBooleanList other, int otherFrom)
        {
            int Length = to - from + 1;
            if (Length > 0)
            {
        ...
        /// </pre>
        public virtual void ReplaceFromToWithFromTo(int from, int to, AbstractBooleanList other, int otherFrom, int otherTo)
        {
        ...
        /// Replaces exactly <i>System.Math.Max(0,System.Math.Min(_size-from, other.Size))</i> elements.
        /// 
        /// <summary>
        ...
        public override void ReplaceFromWith(int from, ICollection<Boolean> other)
        {
            CheckRange(from, _size);
            IEnumerator<Boolean> e = other.GetEnumerator();
            int index = from;
            int limit = System.Math.Min(_size - from, other.Count);
            for (int i = 0; i < limit; i++)
            {
                e.MoveNext();
                this[index++] = ((Boolean)(e.Current)); //delta
            }
        }
        /// <summary>
        ...
        /// <exception cref="IndexOutOfRangeException">if <i>index &lt; 0 || index &gt;= _size</i>. </exception>
        [Obsolete("Deprecated, use this[index] property instead.", true)]
        public virtual void Set(int index, Boolean element)
        {
            if (index >= _size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + _size);
        ...
        ///       this.SetSizeRawRaw(_size-(to-from+1));
        ///    }
        /// }
        /// <summary>
        protected virtual void SetSizeRaw(int new_size)
        {
            _size = new_size;
        }
        /// <summary>
        ...
        /// <summary>
        /// Transforms a Boolean value to an int (false --> 0, true --> 1)
        /// <summary>
        ...
        {
            int mySize = _size;
            var array = new Boolean[mySize];
            for (int i = 0; i < mySize; i++) array[i] = this[i];
            return array;
        }
        ...
        /// <summary>
        public override List<Boolean> ToList()
        {
            int mySize = _size;
            var list = new List<Boolean>(mySize);
