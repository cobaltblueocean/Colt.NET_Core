...
namespace Cern.Colt.List
{
    ...
    /// </summary>
    public class ShortArrayList : AbstractShortList
    {
        /// <summary>
        ...
        public override short[] Elements
        {
        ...
        /// <summary>
        /// <param name="elements">the array to be backed by the the constructed list</param>
        public ShortArrayList(List<short> elements)
        {
        ...
        public ShortArrayList(int initialCapacity) : this(new short[initialCapacity])
        {
            SetSizeRaw(0);
        }
        /// <summary>
        ...
        public override void BeforeInsert(int index, short element)
        {
        ...
        public override int BinarySearchFromTo(short key, int from, int to)
        {
        ...
        {
            // overridden for performance only.
            ShortArrayList clone = new ShortArrayList((short[])_elements.Clone());
        ...
        public override short[] GetElements()
        {
            return _elements;
        }
        /// <summary>
        ...
        public override AbstractShortList SetElements(short[] elements)
        {
        ...
        { //delta
          // overridden for performance only.
          //if (!(otherObj is ShortArrayList)) return base.Equals(otherObj);
            if (this == otherObj) return true;
            if (!(otherObj is ShortArrayList))
            {
                if (otherObj is IList<short>)
                {
                    var other = (IList<short>)otherObj;
            ...
            else
            {
                ...
                var other = (ShortArrayList)otherObj;
        ...
        public override Boolean ForEach(ShortProcedureDelegate procedure)
        {
            // overridden for performance only.
        ...
        /// <summary>
        /// <param name="index">index of element to return.</param>
        protected override short GetQuick(int index)
        {
            return _elements[index];
        }
        /// <summary>
        ...
        public override int IndexOfFromTo(short element, int from, int to)
        {
            // overridden for performance only.
            if (Size == 0) return -1;
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (<i>Size&gt;0 && (from&lt;0 || from&gt;to || to&gt;=Size)</i>). </exception>
        public override AbstractShortList PartFromTo(int from, int to)
        {
            if (Size == 0) return new ShortArrayList(0);

            CheckRangeFromTo(from, to, Size);

            var part = new short[to - from + 1];
        ...
        public override Boolean RemoveAll(AbstractShortList other)
        {
            // overridden for performance only.
            if (!(other is ShortArrayList)) return base.RemoveAll(other);
        ...
        public override void ReplaceFromToWithFrom(int from, int to, AbstractShortList other, int otherFrom)
        {
            // overridden for performance only.
            ...
            if (Length > 0)
            {
                ...
                Array.Copy(((ShortArrayList)other).Elements, otherFrom, _elements, from, Length);
            }
        }
        /// <summary>
        ...
        /// <returns><code>true</code> if the receiver changed as a result of the call.</returns>
        public override Boolean RetainAll(AbstractShortList other)
        {
            // overridden for performance only.
            if (!(other is ShortArrayList)) return base.RetainAll(other);
        ...
        /// <exception cref="IndexOutOfRangeException">index is out of range (index </exception>
        /// 		  &lt; 0 || index &gt;= Size).
        public override void Set(int index, short element)
        {
            // overridden for performance only.
            if (index >= Size || index < 0)
                throw new IndexOutOfRangeException("Index: " + index + ", Size: " + Size);
        ...
        /// <param name="index">index of element to replace.</param>
        /// <param name="element">element to be stored at the specified position.</param>
        protected override void SetQuick(int index, short element)
        {
            _elements[index] = element;
        }
        /// <summary>
        ...
        public override void Insert(int index, short item)
        {
            BeforeInsert(index, item);
        }

        public override void CopyTo(short[] array, int arrayIndex)
        {
