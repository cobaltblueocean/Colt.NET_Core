// <copyright file="SelectedDenseObjectMatrix2D.cs" company="CERN">
...
{
    /// <summary>
    /// Selection view on dense 2-d matrices holding <i>Object</i> elements.
    ...
    public class SelectedDenseObjectMatrix2D : ObjectMatrix2D
    {
        ...
        public SelectedDenseObjectMatrix2D(Object[] elements, int[] rowOffsets, int[] columnOffsets, int offset) : this(rowOffsets.Length, columnOffsets.Length, elements, 0, 0, 1, 1, rowOffsets, columnOffsets, offset)
        {
        }
        ...
        /// <param name="columnOffsets">The column offsets of the cells that shall be visible.</param>
        /// <param name="offset"></param>
        public SelectedDenseObjectMatrix2D(int rows, int columns, Object[] elements, int rowZero, int columnZero, int rowStride, int columnStride, int[] rowOffsets, int[] columnOffsets, int offset)
        {
