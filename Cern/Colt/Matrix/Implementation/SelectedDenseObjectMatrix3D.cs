// <copyright file="SelectedDenseObjectMatrix3D.cs" company="CERN">
...
namespace Cern.Colt.Matrix.Implementation
{
    ...
    public class SelectedDenseObjectMatrix3D : ObjectMatrix3D
    {
        ...
        public SelectedDenseObjectMatrix3D(Object[] elements, int[] sliceOffsets, int[] rowOffsets, int[] columnOffsets, int offset)
        {
        ...
        public override ObjectMatrix2D ViewColumn(int column)
        {
            CheckColumn(column);
        ...
        public override ObjectMatrix2D ViewRow(int row)
        {
            CheckRow(row);
        ...
        /// <see cref="ViewRow(int)"/>
        /// <see cref="ViewColumn(int)"/>
        public override ObjectMatrix2D ViewSlice(int slice)
        {
            CheckSlice(slice);
