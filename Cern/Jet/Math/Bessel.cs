...
namespace Cern.Jet.Math
{
    ...
    public class Bessel : Constants
    {
        ...
        /// 
        /// Chebyshev coefficients for K0(x) + log(x/2) I0(x) in the interval [0,2]d  The odd order coefficients are all zero; only the even order coefficients are listed.
        ...
        static public double i0(double x)
        {
            ...
            {
                y = (x / 2.0) - 2.0;
                return (System.Math.Exp(x) * Arithmetic.Chbevl(y, A_i0, 30));
            }

            return (System.Math.Exp(x) * Arithmetic.Chbevl(32.0 / x - 2.0, B_i0, 25) / System.Math.Sqrt(x));
        }
        ...
        static public double i1(double x)
        {
            ...
            {
                y = (z / 2.0) - 2.0;
                z = Arithmetic.Chbevl(y, A_i1, 29) * z * System.Math.Exp(z);
            }
            else
            {
                z = System.Math.Exp(z) * Arithmetic.Chbevl(32.0 / z - 2.0, B_i1, 25) / System.Math.Sqrt(z);
            }
            if (x < 0.0)
        ...
        static public double k0(double x)
        {
            ...
            z = 8.0 / x - 2.0;
            y = System.Math.Exp(-x) * Arithmetic.Chbevl(z, B_k0, 25) / System.Math.Sqrt(x);
            return (y);
        }
        ...
        static public double k1(double x)
        {
            ...
            {
                y = x * x - 2.0;
                y = System.Math.Log(z) * i1(x) + Arithmetic.Chbevl(y, A_k1, 11) / x;
                return (y);
            }

            return (System.Math.Exp(-x) * Arithmetic.Chbevl(8.0 / x - 2.0, B_k1, 25) / System.Math.Sqrt(x));
        }
        ...
        static public double kn(int nn, double x)
        {
            ...
            */
            ...
            if (x <= 9.55)
            {
                ...
                if (n > 0)
                {
                    ...
                    else
                    {
                        ...
                        for (i = 1; i < n; i++)
                        {
                            ...
                            t = nk1f * zn / kf;
                            s += t;
                            if ((MAXNUM - System.Math.Abs(t)) < System.Math.Abs(s)) throw new ArithmeticException("Overflow");
                ...
                while (System.Math.Abs(t / s) > MACHEP);
            ...
            do
            {
                ...
                if ((i >= n) && (nk1f > nkf))
                {
                    ans = System.Math.Exp(-x) * System.Math.Sqrt(System.Math.PI / (2.0 * x)) * s;
                    return (ans);
                }
                nkf = nk1f;
                s += t;
